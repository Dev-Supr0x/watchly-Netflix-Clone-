...
const Moviepage = () => {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5ZDdlNDI0NTA4ZDY0MzFkODBhYjcwOGYyYzIwOTU2NyIsIm5iZiI6MTc1MDc5MzMwNS40MjIwMDAyLCJzdWIiOiI2ODVhZmM1OTk5OGUxZWJhN2FjOWNjZmYiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.PFMMlcNU2Jwlb3s-Qc43fP8y9GHqEuqGWZP6Hv_IIkc',
    },
  };
